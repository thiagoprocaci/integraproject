 ...
 * 
 */
public class DeletedGoogleUserDaoHibernate extends
		GenericDaoHibernate<DeletedGoogleUser, Integer> implements
		DeletedGoogleUserDao {
	...
	@Override
	public List<DeletedGoogleUser> getAllByDomainName(String domainName)
			throws Exception {
		return getHibernateTemplate().find(
				"select d from DeletedGoogleUser d where d.domain.name = ?",
				domainName);
	}
	...
	public List<DeletedGoogleUser> getDeletedGoogleUserUntilFiveDaysAgoByDomainName(
		...
		return getHibernateTemplate()
				.find(
						"select d from DeletedGoogleUser d where d.exclusionDate between  ? and ? ",
						new Calendar[] { fiveDaysAgo, Calendar.getInstance() });
	}
	...
	public List<String> getDeletedGoogleAccountUntilFiveDaysAgoByDomainName(
		...
		return getHibernateTemplate()
				.find(
						"select d.deletedGoogleAccount from DeletedGoogleUser d where d.exclusionDate between  ? and ? ",
						new Calendar[] { fiveDaysAgo, Calendar.getInstance() });
	}
