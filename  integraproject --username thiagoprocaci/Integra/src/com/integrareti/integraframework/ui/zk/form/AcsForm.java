...
public class AcsForm extends Form {	
	...
	public void setRelayStateByDomain(String domainName) {
		if (domainName == null) 
			throw new IllegalStateException(
					"The domain name must be specified at relayState");
	 ...
	 * 
	 * @param samlResponse
	 * @param relayState (googleBaseURL + domainName)
	 */
	...
	private void verifyState() {
		if (relayStateTextArea.getDynamicProperty("value") == null
				|| samlResponseTextArea.getDynamicProperty("value") == null) {
			throw new IllegalStateException(
					"Be sure relayState and samlResponse are not null. Respestively the are: "
							+ relayStateTextArea.getDynamicProperty("value")
							+ " , "
							+ samlResponseTextArea.getDynamicProperty("value"));
